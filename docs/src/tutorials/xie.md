...
```
    ...
    Info    : Done meshing 1D (Wall 6.69749e-05s, CPU 7e-05s)
    Info    : Meshing 2D...
    Info    : Meshing surface 1 (Sphere, Frontal-Delaunay)
    Info    : Done meshing 2D (Wall 0.0248921s, CPU 0.024882s)
    Info    : 976 nodes 1975 elements
    Info    : Writing '/tmp/jl_89Mv8hUBit.msh'...
    Info    : Done writing '/tmp/jl_89Mv8hUBit.msh'
...
```
    ...
    Info    : Meshing 1D...
    Info    : [ 40%] Meshing curve 2 (Circle)
    Info    : Done meshing 1D (Wall 6.84969e-05s, CPU 7.4e-05s)
    Info    : Meshing 2D...
    Info    : Meshing surface 1 (Sphere, Frontal-Delaunay)
    Info    : Done meshing 2D (Wall 0.0242726s, CPU 0.024268s)
    Info    : 976 nodes 1975 elements
    Info    : Writing '/tmp/jl_w1yRcpClCD.msh'...
    Info    : Done writing '/tmp/jl_w1yRcpClCD.msh'
